...
\myskip 
    ...
    \end{align}
    where $\Var(X) \coloneqq \EE[(X - \EE X)^2]$.
...
\end{align}
Recall that $H(p) \coloneqq - p \log p - (1-p)\log (1-p)$.
...
$G_d(q)$ is the log-partition function (or ``free energy'' in statistical physics) of 
