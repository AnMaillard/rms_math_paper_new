...
\begin{enumerate}
    ...
    \item Add the new section on sharp second moment asymptotics.
    \item Add the second moment lower bound on a small dedicated figure in Section~\ref{sec:limits_2nd_moment}.
\end{enumerate}
}
...
\new{
\section{Limits of the second moment method}\label{sec:limits_2nd_moment}
\input{sections/limits_2nd_moment.tex}
}
