...
Whether the solution space to average-case matrix discrepancy presents similar geometric features is a stimulating question, especially as the failure of the second moment method in parts of the phase diagram might indicate a richer picture than in the SBP.
